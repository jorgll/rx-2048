...
<doc>
    ...
    <members>
        ...
        <member name="T:ReactNative.UIManager.IViewManagerExtension">
            <summary>
            An interface for extending view managers with additional props.
            </summary>
        </member>
        <member name="P:ReactNative.UIManager.IViewManagerExtension.ViewManagerType">
            <summary>
            The type of view manager type being extended.
            </summary>
        </member>
        <member name="P:ReactNative.UIManager.IViewManagerExtension.CommandsMap">
            <summary>
            The commands map for the view manager extension.
            </summary>
        </member>
        <member name="P:ReactNative.UIManager.IViewManagerExtension.ExportedCustomBubblingEventTypeConstants">
            <summary>
            The exported custom bubbling event types.
            </summary>
        </member>
        <member name="P:ReactNative.UIManager.IViewManagerExtension.ExportedCustomDirectEventTypeConstants">
            <summary>
            The exported custom direct event types.
            </summary>
        </member>
        <member name="P:ReactNative.UIManager.IViewManagerExtension.ExportedViewConstants">
            <summary>
            The exported view constants.
            </summary>
        </member>
        <member name="P:ReactNative.UIManager.IViewManagerExtension.NativeProperties">
            <summary>
            The native props for the view manager extension.
            </summary>
        </member>
        <member name="M:ReactNative.UIManager.IViewManagerExtension.OnCreateView(ReactNative.UIManager.ThemedReactContext,System.Windows.DependencyObject)">
            <summary>
        ...
        <member name="M:ReactNative.UIManager.IViewManagerExtension.OnDropViewInstance(ReactNative.UIManager.ThemedReactContext,System.Windows.DependencyObject)">
            <summary>
            Called when view is detached from view hierarchy and allows for 
            additional cleanup by the <see cref="T:ReactNative.UIManager.IViewManagerExtension"/>
            subclass.
            </summary>
            <param name="reactContext">The React context.</param>
            <param name="view">The view.</param>
        </member>
        <member name="M:ReactNative.UIManager.IViewManagerExtension.ReceiveCommand(System.Windows.DependencyObject,System.Int32,Newtonsoft.Json.Linq.JArray)">
            <summary>
        ...
        <member name="M:ReactNative.UIManager.IViewManagerExtension.UpdateProperties(System.Windows.DependencyObject,ReactNative.UIManager.ReactStylesDiffMap)">
            <summary>
        ...
        <member name="M:ReactNative.UIManager.UIViewOperationQueue.PrependUIBlock(ReactNative.UIManager.IUIBlock)">
            <summary>
        ...
        <member name="M:ReactNative.UIManager.ViewManager`2.UpdateProperties(System.Windows.DependencyObject,ReactNative.UIManager.ReactStylesDiffMap)">
            <summary>
            Update the properties of the given view.
            </summary>
            <param name="viewToUpdate">The view to update.</param>
        ...
        <member name="T:ReactNative.UIManager.ViewManagerExtension`2">
            <summary>
        ...
        <member name="P:ReactNative.UIManager.ViewManagerExtension`2.ViewManagerType">
            <summary>
            The type of view manager type being extended.
            </summary>
        </member>
        <member name="P:ReactNative.UIManager.ViewManagerExtension`2.CommandsMap">
            <summary>
            The commands map for the view manager extension.
            </summary>
        </member>
        <member name="P:ReactNative.UIManager.ViewManagerExtension`2.ExportedCustomBubblingEventTypeConstants">
            <summary>
            The exported custom bubbling event types.
            </summary>
        </member>
        <member name="P:ReactNative.UIManager.ViewManagerExtension`2.ExportedCustomDirectEventTypeConstants">
            <summary>
            The exported custom direct event types.
            </summary>
        </member>
        <member name="P:ReactNative.UIManager.ViewManagerExtension`2.ExportedViewConstants">
            <summary>
            The exported view constants.
            </summary>
        </member>
        <member name="P:ReactNative.UIManager.ViewManagerExtension`2.NativeProperties">
            <summary>
            The native props for the view manager extension.
            </summary>
        </member>
        <member name="M:ReactNative.UIManager.ViewManagerExtension`2.OnCreateView(ReactNative.UIManager.ThemedReactContext,`0)">
            <summary>
            Called when the view is created.
            </summary>
            <param name="reactContext">The context.</param>
        ...
        <member name="M:ReactNative.UIManager.ViewManagerExtension`2.OnDropViewInstance(ReactNative.UIManager.ThemedReactContext,`0)">
            <summary>
            Called when view is detached from view hierarchy and allows for 
            additional cleanup by the <see cref="T:ReactNative.UIManager.IViewManagerExtension"/>
            subclass.
        ...
        <member name="M:ReactNative.UIManager.ViewManagerExtension`2.ReceiveCommand(`0,System.Int32,Newtonsoft.Json.Linq.JArray)">
            <summary>
            Implement this method to receive events/commands directly from
            JavaScript through the <see cref="N:ReactNative.UIManager"/>.
            </summary>
        ...
        <member name="M:ReactNative.UIManager.ViewManagerExtension`2.UpdateProperties(System.Windows.DependencyObject,ReactNative.UIManager.ReactStylesDiffMap)">
            <summary>
            Update the properties of the given view.
            </summary>
            <param name="viewToUpdate">The view to update.</param>
        ...
        <member name="M:ReactNative.UIManager.ViewManagerExtension`2.AddEventEmitters(ReactNative.UIManager.ThemedReactContext,`0)">
            <summary>
            Subclasses can override this method to install custom event 
            emitters on the given view.
            </summary>
        ...
        <member name="M:ReactNative.UIManager.ViewManagerExtension`2.OnAfterUpdateTransaction(`0)">
            <summary>
            Callback that will be triggered after all properties are updated in
            the current update transation (all <see cref="T:ReactNative.UIManager.Annotations.ReactPropAttribute"/> handlers
            for properties updated in the current transaction have been called).
        ...
        <member name="F:ReactNative.Views.View.ReactViewManager._defaultBorderBrush">
            <summary>
        ...
        <member name="T:ReactNative.IViewManagerExtensionProvider">
             <summary>
             Interface for exposing native view manager extensions.
             </summary>
             <remarks>
             To add <see cref="T:ReactNative.UIManager.IViewManagerExtension"/> instances to your application,
             extend your <see cref="T:ReactNative.Modules.Core.IReactPackage" /> implementation with this
             interface, e.g.:
             <code>
        ...
        <member name="M:ReactNative.IViewManagerExtensionProvider.CreateViewManagerExtensions(ReactNative.Bridge.ReactContext)">
            <summary>
            Creates the list of view manager extensions that should be
            registered with the <see cref="T:ReactNative.UIManager.UIManagerModule"/>.
            </summary>
            <param name="reactContext">The React context.</param>
            <returns>The list of view managers.</returns>
        </member>
        ...
        <member name="T:ReactNative.ReactInstanceManagerExtensions">
            <summary>
            Extension methods for the React instance manager.
            </summary>
        </member>
        <member name="M:ReactNative.ReactInstanceManagerExtensions.GetOrCreateReactContextAsync(ReactNative.ReactInstanceManager,System.Threading.CancellationToken)">
            <summary>
        ...
        <member name="P:ReactNative.ReactInstanceManager.HasStartedCreatingInitialContext">
            <summary>
            Signals whether <see cref="M:ReactNative.ReactInstanceManager.CreateReactContextAsync(System.Threading.CancellationToken)"/> has
