...
var RootView = /** @class */ (function (_super) {
                        ...
                        if (isClickOnAnchor || isClickOnContainer) {
                            ...
                            if (_this.props.activePopupOptions.onAnchorPressed) {
                                setTimeout(function () {
                                    ...
                                    _this.props.activePopupOptions.onAnchorPressed(undefined);
                                }, 500);
                            }
    ...
    RootView.prototype.render = function () {
        ...
        if (this.props.activePopupOptions) {
            ...
            optionalPopup = (React.createElement("div", { style: popupContainerStyle, ref: this._onMount, onMouseEnter: function (e) { return _this._onMouseEnter(e); }, onMouseLeave: function (e) { return _this._onMouseLeave(e); } }, this.props.activePopupOptions.renderPopup(this.state.anchorPosition, this.state.anchorOffset, this.state.constrainedPopupWidth, this.state.constrainedPopupHeight)));
        }
        ...
        return (React.createElement("div", { className: this.state.focusClass, style: rootViewStyle },
            ...
            optionalModal,
            optionalPopup,
            React.createElement("div", { style: _styles.liveRegionContainer, "aria-live": AccessibilityUtil_1.default.accessibilityLiveRegionToString(Types.AccessibilityLiveRegion.Polite), "aria-atomic": 'true', "aria-relevant": 'text' }, announcement)));
    };
    ...
    RootView.prototype._recalcPosition = function () {
        ...
        var anchorComponent = this.props.activePopupOptions.getAnchor();
